...
?>
		<ul id="slide-out" class="side-nav">
          ...
          <li class="<?= (\Yii::$app->controller->id == 'site' && \Yii::$app->controller->action->id == 'yakutskmaster') ? 'active' : ''; ?>"><a href="<?= Url::toRoute('site/yakutskmaster'); ?>"><i class="material-icons">build</i>Служба ремонта ПК и ПО</a></li>
