                ...
                <div class="row d-flex justify-content-between">
                    <div class="col-12 col-md-6">
                        <div class="mb-40">
                            ...
                            <p>ООО «МЕДИСИТИ»</p>
                            <h6>Гаврил Сивцев</h6>
                            <p>В 2018 году мы заказали сайт для нашей компании, занимающейся медицинским туризмом в Южную Корею. Сайт был разработан и готов к работе уже через месяц. Стоимость проекта была вполне приемлемой. Мы считаем, что это гораздо более эффективное решение, чем создание сайта-визитки. После запуска мы получили возможность самостоятельно редактировать и обновлять информацию на сайте. Мы довольны качеством работы и сервисом. Благодарим специалистов за профессионализм и оперативность! Сайт стал нашим надёжным помощником в продвижении услуг по медицинскому туризму. Благодаря удобному интерфейсу и информативному наполнению, посетители легко находят нужные сведения и могут быстро связаться с нами для получения дополнительной информации или записи на консультацию.</p>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="mb-40">   
                            ...
                            <p>Ресурсный центр социальной защиты «Победа» благодарит ООО «Информационные технологии Якутии» за разработку сайта нашей организации. Разработанный вами сайт rcmtykt.ru имеет социальную направленность и предназначен для организаций соцзащиты и социального обслуживания Республики Саха (Якутия), а также граждан, нуждающихся в поддержке. Сайт удобен в использовании, имеет современный дизайн и возможности проведения опросов. Работа выполнена с учётом всех наших требований и пожеланий, в установленные сроки. Желаем успехов в продвижении новых проектов и готовы к дальнейшему сотрудничеству!</p>
