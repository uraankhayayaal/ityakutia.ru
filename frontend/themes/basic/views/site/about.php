                ...
                <div class="row">
                    <div class="offset-xl-1 col-lg-8">
                        <div class="about-details-cap mb-50">
                            <h4>Наша миссия</h4>
                            <p>Развивать цифровую экономику путем создания уникальных дизайнов, медиа контента, автоматизации бизнеса и освещения в социальных сетях наших клиентов.</p>
                            <p></p>
                        </div>
